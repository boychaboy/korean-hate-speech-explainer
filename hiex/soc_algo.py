...
class _SamplingAndOcclusionAlgo(_SamplingAndOcclusionBaseAlgo):
    ...
    def occlude_input_with_masks_and_run(
        ...
        if self.gpu >= 0:
            ...
            inp_enb_mask, inp_ex_mask = (
                inp_enb_mask.to(self.gpu),
                inp_ex_mask.to(self.gpu),
            )
        ...
        logits_enb = self.model(
            inp_enb, segment_ids[:, : inp_enb.size(1)], inp_enb_mask
        )
        ...
        contrib_logits = logits_enb - logits_ex  # [B]
    ...
    def do_hierarchical_explanation(
        ...
        logits_pred = self.model(input_ids, segment_ids, input_mask)[0]
